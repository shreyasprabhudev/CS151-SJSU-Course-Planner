...
class AdminAddCourse extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {		
		if (e.getSource() == addCourseConfirmBtn) {
			if (frame.control.getCourse((String) addCourseNameField.getText()) != null) {
				...
				frame.pageTransition(frame.adminPage);
			}
...
class AdminRemoveCourse extends JFrame implements ActionListener {
